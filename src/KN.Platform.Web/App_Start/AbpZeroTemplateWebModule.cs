...
using KN.Platform.Web.App.Startup;//SPA!
using KN.Platform.Web.Areas.Mpa.Startup;//MPA!
using KN.Platform.Web.Bundling;
using KN.Platform.Web.Navigation;
using KN.Platform.Web.Routing;
using KN.Platform.WebApi;
